      ...
      <div className="container" style={{ maxWidth: 960 }}>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: C.gray500, fontSize: '0.9375rem' }}>
              {user?.email}
            </p>
          </div>
          <Link to="/editor">
        ...
        <div style={{
          ...
          />
          <StatCard
            icon={<Film size={20} color={C.gray500} />}
            label="Проекты"
            value={0}
          />
          <StatCard
            icon={<CreditCard size={20} color={C.gray500} />}
            label="Тариф"
            value="Бесплатный"
            link="/billing"
          />
...
function StatCard({ icon, label, value, accent, link }) {
  const content = (
    <div style={{
      background: C.white,
      border: `1px solid ${accent ? C.primary + '30' : C.gray200}`,
      borderRadius: 16,
      padding: '20px 24px',
      display: 'flex',
      alignItems: 'center',
