...
**Три модели оживления:**
- **Kling 2.5 turbo** — эконом, рабочая лошадка ($0.21/ролик, 5 сек, без аудио). Заменил Wan 2.7 (Wan давал «лотерею» движения и плыл текст).
- **Cosmos 3 Super** — средний тир ($0.35/ролик: $0.05/сек × 7 сек, 480×832 вертикаль, 189 кадров @ 24 fps, без аудио). `enable_agentic_generation: false` — КРИТИЧНО: agentic-режим кратно умножает стоимость. Свои пресеты с кинематографической терминологией (`COSMOS_PRESETS`) и `COSMOS_NEGATIVE_PROMPT`.
- **Veo 3.1 fast** — премиум-апселл (720p, 8 сек, аудио выключено, эффектнее, ~$1.20/ролик).
